...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="shortcut icon" href="/image/handyman.png" type="image/x-icon">
    ...
    <body>
        <header>
            <a href="index.php">
                <img src="/image/handyman-3.png" alt="logo of the company" width="150px">
            </a>
            <nav>
                <h2><a href="#">home</a></h2>
            ...
            <div class="links">
                <h3><a href="signin.php" class="getin">signin</a></h3>
                <h3><a href="login.php" class="getin">login</a></h3>
            </div>
        </header>
        <div class="center">
            @yield('contant')
